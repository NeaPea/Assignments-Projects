...
function gameEnded(){
    ...
    document.getElementById('output').setAttribute('readonly', 'readonly'); // can't click on the input field
}
function easyMode(){
    maxGuesses = 10;
   ...
   $('attempts').innerHTML = attempts; // show the counts attempts  
    if(userGuessLog.length < maxGuesses){
        if (userGuess > computerGuess) { 
            ...
            document.getElementById('output').value =""; // clear input field each time it have been guessed
